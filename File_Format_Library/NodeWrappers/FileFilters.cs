...
namespace FirstPlugin
{
    public class FileFilters
    {
        ...
        public static string FSKA_EXPORT = GetFilter(".bfska", ".anim", ".seanim", ".smd", ".chr0", ".json");
        public static string FSKA_REPLACE = GetFilter(".bfska",".anim", ".seanim", ".smd", ".chr0", ".json");
        ...
        public static Dictionary<string, string> GetDescription(string[] extensions)
        {
            ...
            foreach (string ext in extensions)
            {
                switch (ext)
                {
                    ...
                    case ".json": filters.Add(ext, "Unity Animation Convertor"); break;
                    default:
